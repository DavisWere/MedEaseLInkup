    ...
    <!-- <div class="mainContainer"> -->
        <div class="sidebar">
           ...
           <ul>
                ...
                <li><a href="#" style="color: black;"><svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-calendar3" viewBox="0 0 16 16">
                    <path d="M14 0H2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zM1 3.857C1 3.384 1.448 3 2 3h12c.552 0 1 .384 1 .857v10.286c0 .473-.448.857-1 .857H2c-.552 0-1-.384-1-.857V3.857z"/>
                    <path d="M6.5 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
                  </svg></a></li>
                <li><a href="faqsanswers.php"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-question-circle-fill" viewBox="0 0 16 16">
        ...
        <div class="contentMain">
            ...
            <div class="bodyContainer">
                <div class="patientApp">
                    <h2 style="text-align: center;padding: 20px;padding-left: 0;"><b>APPOINTMENT RECORDS</b></h2>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody class="table-group-divider">
                              <tr>
                                ...
                                <td>Doctor James Smith</td>
                                <td>jamessmith556@gmail.com</td>
                                <td>23/08/23 08:00:56</td>
                               <td style="text-align: center;"><button class="btn btn-secondary">Pending</button></td>
                              </tr>
                              <tr>
                                <td>2</td>
                                <td>Charlie Doe</td>
                                <td>cdoe@gmail.com</td>
                                <td>Dr. Hannah M</td>
                                <td>hannah112@yahoo.com</td>
                                <td>23/08/22 08:00:56</td>
                                <td style="text-align: center;"><button class="btn btn-success">Complete</button></td>
                              </tr>
                            </tbody>
                        </table>
                    </div>
