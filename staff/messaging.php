...
<body>
        <div class="sidebar">
           ...
           <ul>
                ...
                <li><a href="messaging.php" style="color: black;"><svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-chat-right-text-fill" viewBox="0 0 16 16">
