    ...
    <!-- <div class="mainContainer"> -->
        <div class="sidebar">
           ...
           <div class="sidebarnav">
              <ul>
                ...
                <li><a href="#" style="color: black;"><svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16">
        ...
        <div class="contentMain">
            ...
            <div class="bodyContainer">
                <div class="financeRecords">
                    <h2 style="text-align: center;padding: 20px;padding-left: 0;"><b>PAYMENT HISTORY</b></h2>
