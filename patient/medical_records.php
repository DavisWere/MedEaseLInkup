        ...
        <div class="sidebar">
           ...
           <div class="sidebarnav">
              <ul>
                ...
                <li><a href="booking.php"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-calendar-plus-fill" viewBox="0 0 16 16">
                    <path d="M4 .5a.5.5 0 0 0-1 0V1H2a2 2 0 0 0-2 2v1h16V3a2 2 0 0 0-2-2h-1V.5a.5.5 0 0 0-1 0V1H4V.5zM16 14V5H0v9a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2zM8.5 8.5V10H10a.5.5 0 0 1 0 1H8.5v1.5a.5.5 0 0 1-1 0V11H6a.5.5 0 0 1 0-1h1.5V8.5a.5.5 0 0 1 1 0z"/>
                  </svg></a></li>
                <li><a href="#" style="color: black;"><svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-clipboard2-pulse-fill" viewBox="0 0 16 16">
        ...
        <div class="contentMain">
            ...
            <div class="bodyContainer">
                <div class="medicalRecords">
                    <h2 style="text-align: center;padding: 20px;padding-left: 0;"><b>PAST MEDICAL RECORDS</b></h2>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody class="table-group-divider">
                              <tr>
                                ...
                                <td>Cold</td>
                                <td>Mark Nairobi</td>
                               <td style="text-align: center;"><button class="btn btn-warning">Review</button></td>
                                <td>Excellent</td>
                              </tr>
                              <tr>
                                <td>2</td>
