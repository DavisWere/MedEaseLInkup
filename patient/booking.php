...
<body>
        <div class="sidebar">
           ...
           <ul>
                <li><a href="patient_dashboard.php"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-house-fill" viewBox="0 0 16 16">
                    <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L8 2.207l6.646 6.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.707 1.5Z"/>
                    <path d="m8 3.293 6 6V13.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5V9.293l6-6Z"/>
                  </svg></a></li>
                <li><a href="#" style="color: black;"><svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-calendar-plus-fill" viewBox="0 0 16 16">
        ...
        <div class="contentMain">
            ...
            <div class="bookingContainer">
                <h2 style="text-align: center;padding: 20px;padding-left: 0;"><b>BOOK APPOINTMENT</b></h2> 
                <div class="bookingCont">
                    <form action="" method="post">
                        <label for="date" id="date-time">Date / Time :</label><br>
                        <input class="bookvalue" type="datetime-local" name="date" id="date-time" required>
                        <label for="diagnosis" id="diagnosis">Diagnosis :</label><br>
                        <input class="bookvalue" type="text" name="diagnosis" id="diagnosis" required><br>
                        <input style="width: 17px;height: 17px;margin:.5em;" type="checkbox" name="check" id="check" checked required><small>Make KSH 200 payment as consultation fee. <br>You will receive a prompt to enter your pin.</small><br>
